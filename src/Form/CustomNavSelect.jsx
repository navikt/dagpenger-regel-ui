...
// todo gjøre om til en pure function
class CustomNavSelect extends Component {
  ...
  render() {
    ...
    return (
      <NavSelect {...otherProps} selectRef={() => handleSelectRef()} value={hideValueOnDisable && disabled ? '' : selectedValue(value)} disabled={disabled}>
        {placeholder && (
