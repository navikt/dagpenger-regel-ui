...
export const RadioOption = ({ name, label, value, actualValue, disabled, groupDisabled, onChange, children }) => {
...
RadioOption.propTypes = {
  ...
  actualValue: PropTypes.oneOfType([PropTypes.string, PropTypes.number, PropTypes.bool]),
