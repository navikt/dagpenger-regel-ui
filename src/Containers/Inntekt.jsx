...
const Inntekt = ({ readOnly, inntekter, virksomhet, columnId, monthIndex }) => {
                ...
                {!readOnly && (
                  <div className="knapprad midstill">
                    ...
                    <Modal
                      ...
                      ariaHideApp={false}
                    >
                      <NyInntekt virksomhet={virksomhet} dato={columnId} arrayHelpers={arrayHelpers} closeModal={() => setNyInntektModal(false)} />
                    </Modal>
                  </div>
                )}
              </>
